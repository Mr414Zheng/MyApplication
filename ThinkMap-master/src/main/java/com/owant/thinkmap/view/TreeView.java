...
public class TreeView extends ViewGroup implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    private void boxCallBackChange(int dx, int dy) {
        ...
        Log.w("box", box.toString());

        int w = box.right + dy;
        int h = box.bottom - box.top;
        Log.w(TAG, "beLayout: " + getMeasuredWidth() + "," + getMeasuredHeight());
        //重置View的大小
     ...
     * @param to
     */
    private void drawLineToViewFirst(Canvas canvas, View from, View to) {
